...
export const VisualPublication=z.object({
 ...
 circuits:z.array(z.object({capabilityId:z.string(),capabilityDefinitionPk:z.string(),scenarioId:z.string(),definitionPk:z.string(),objectPk:z.string(),bundleRevision:hash,label:z.string(),url:localUrl,artifacts:z.array(localUrl),scope:z.literal('DECLARED_SOURCE_BOUNDARY')})),
